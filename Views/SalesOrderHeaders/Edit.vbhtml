...
@Using (Html.BeginForm())
    ...
    @<div class="form-horizontal">
        ...
        @Html.HiddenFor(Function(model) model.SalesOrderID)
        ...
        <div class="form-group">
            @Html.LabelFor(Function(model) model.SalesOrderNumber, htmlAttributes:= New With { .class = "control-label col-md-2" })
            <div class="col-md-10">
                @Html.EditorFor(Function(model) model.SalesOrderNumber, New With { .htmlAttributes = New With { .class = "form-control" } })
                @Html.ValidationMessageFor(Function(model) model.SalesOrderNumber, "", New With { .class = "text-danger" })
            </div>
        </div>
        ...
        <div class="form-group">
            @Html.LabelFor(Function(model) model.TotalDue, htmlAttributes:= New With { .class = "control-label col-md-2" })
            <div class="col-md-10">
                @Html.EditorFor(Function(model) model.TotalDue, New With { .htmlAttributes = New With { .class = "form-control" } })
                @Html.ValidationMessageFor(Function(model) model.TotalDue, "", New With { .class = "text-danger" })
            </div>
        </div>
